...
import { PropositionVentePage } from './propositionVente/propositionVente';
import  firebase  from 'firebase';
import { AngularFireDatabase } from 'angularfire2/database';
import * as $ from 'jquery';

@Component({
  selector: 'page-choixCollaborateur',
  templateUrl: 'choixCollaborateur.html'
})
export class ChoixCollaborateurPage {
