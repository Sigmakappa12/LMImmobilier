...
import { DataSnapshot } from '../../../node_modules/@firebase/database';
...
export class CreerComptePage {
    ...
    public showVueVente(){
       ...
       // console.log("THISUID :",this.checkUsersRef);
        ...
        if(this.parrainID && this.civility && this.name && this.surname && this.postalCode && this.town && this.country && this.phone && this.mail && this.id) {
